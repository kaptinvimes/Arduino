...
//const int offTime = 1350; // x 8 = 3 hour OFF
//const int offTime = 1800; // x 8 = 4 hour OFF
...
// Reset all Relays to Normal Condition (All Off)
	...
	if (digitalRead(timePeriod) == HIGH) sleepTime = 1800; // 4 hours
...
for (int i = 0; i <= sleepTime; i++)  Sleep();	        // wdt wakes every 8 seconds so 450*8=3600/60 minutes = 1 hour  or 20 ca = 3minutes
...
void Awake()   
{
  ...
  delay(180000); // Wait 2 minutes then check for any alarms   2 minutes = 180000
